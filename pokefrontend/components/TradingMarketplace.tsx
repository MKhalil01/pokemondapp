...
const dummyListings: MarketplaceItem[] = [
  {
    id: 1,
    name: 'Bulbasaur',
    imageUrl: 'https://ipfs.io/ipfs/QmExampleBulbasaur',
    price: 0.1,
  ...
  },
  {
    id: 2,
    name: 'Squirtle',
    imageUrl: 'https://ipfs.io/ipfs/QmExampleSquirtle',
    price: 0.12,
  ...
  return (
    <section className="mt-12">
      <div className="flex justify-between items-center mb-4">
        <h2 className="text-2xl font-bold text-blue-900">Marketplace</h2>
        <button
        ...
        {listings.map((item) => (
          ...
          >
            ...
            <div className="flex-1">
              ...
              <p>{item.price} ETH</p>
              <p className="text-sm text-gray-500">Ends in: {formatTimeRemaining(item.saleEnd)}</p>
            </div>
